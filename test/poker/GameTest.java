...
class GameTest {
    ...
    @CsvSource(value = {
            "2Ca;2Co;Égalité",
            "ACa;7Co;Main 1 (ACa) gagne avec la carte la plus haute : A"
    }, delimiter = ';')
    ...
    @CsvSource(value = {
            ...
            "2Ca ACo;9Co 7Ca;Main 1 (ACo 2Ca) gagne avec la carte la plus haute : A",
    ...
    @CsvSource(value = {
            ...
            "2Ca 2Co ACa;2Tr 2Pi 7Pi;Main 1 (ACa 2Co 2Ca) gagne avec la carte la plus haute : A",
    ...
    @CsvSource(value = {
            ...
            "2Ca 2Co APi 3Tr;2Tr 2Pi 7Co KCa;Main 1 (APi 3Tr 2Ca 2Co) gagne avec la carte la plus haute : A",
    ...
    @CsvSource(value = {
            ...
            "2Ca 2Co ACa 3Ca 4Ca;2Tr 2Pi 7Ca KCa 8Ca;Main 1 (ACa 4Ca 3Ca 2Ca 2Co) gagne avec la carte la plus haute : A",
            ...
            "ACa KCo QCa JCo 10Ca;2Ca KCa 7Ca 10Co 6Ca;Main 1 (ACa KCo QCa JCo 10Ca) gagne avec une suite dont la carte la plus haute est A",
            "ACa KCo QCa JCo 10Ca;2Ca 3Co 4Ca 5Co 6Ca;Main 1 (ACa KCo QCa JCo 10Ca) gagne avec une suite dont la carte la plus haute est A",
